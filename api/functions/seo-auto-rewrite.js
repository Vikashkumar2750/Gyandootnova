...
import { sendAlert } from "../lib/seo-alerts.js";
...
async function rewriteWithAI(post) {
...
async function scoreOriginality(sb, post) {
...
const handler = async (req) => {
  ...
  const maxAttempts = Number(body.max_attempts) || DEFAULT_MAX_ATTEMPTS;
