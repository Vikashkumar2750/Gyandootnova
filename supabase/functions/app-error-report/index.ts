...
function knownAutoFix(message: string): string | null {
...
async function aiDiagnose(message: string, stack: string, route: string) {
...
async function emailAdmin(row: Record<string, unknown>, diagnosis: string | null) {
